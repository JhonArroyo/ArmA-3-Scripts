...
{
hintSilent "";
[cshower6, 5.4, 4,2, true] spawn BIN_fnc_deconShowerAnimLarge;
[cshower7, 5.4, 4,2, true] spawn BIN_fnc_deconShowerAnimLarge;
[
	[
...
[cshower6] call BIN_fnc_deconShowerAnimStop;
[cshower7] call BIN_fnc_deconShowerAnimStop;
sleep 3;
