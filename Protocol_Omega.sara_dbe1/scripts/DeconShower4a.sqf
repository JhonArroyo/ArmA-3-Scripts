...
{
hintSilent "";
[cshower4, 5.4, 4,2, true] spawn BIN_fnc_deconShowerAnimLarge;
[cshower5, 5.4, 4,2, true] spawn BIN_fnc_deconShowerAnimLarge;
[
	[
...
[cshower4] call BIN_fnc_deconShowerAnimStop;
[cshower5] call BIN_fnc_deconShowerAnimStop;
sleep 3;
