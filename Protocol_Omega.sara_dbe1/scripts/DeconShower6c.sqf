...
{
hintSilent "";
[cshower8, 5.4, 4,2, true] spawn BIN_fnc_deconShowerAnimLarge;
[cshower9, 5.4, 4,2, true] spawn BIN_fnc_deconShowerAnimLarge;
[
	[
...
[cshower8] call BIN_fnc_deconShowerAnimStop;
[cshower9] call BIN_fnc_deconShowerAnimStop;
sleep 3;
