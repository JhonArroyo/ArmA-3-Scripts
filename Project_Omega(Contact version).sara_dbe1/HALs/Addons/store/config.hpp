...
class cfgHALsStore {
	...
	class categories {
		...
		class navigationA {
			displayName = "Basic Navigation Components";
		...
		class smgs {
			...
			ITEM(SMG_03C_camo, 300, SMG_STOCK);
		};
		...
		class pharmacyA {
			displayName = "Firts-Aid Basic Items";
			picture = "";
		...
		class navigationB {
			displayName = "Advance Navigation Components";
			picture = "";
	...
	class stores {
		class navigation {
			displayName = "Navigation & Survival Store";
			categories[] = {"navigationA", "survival", "navigationB"};
		};

		class weapon {
			displayName = "Weapons Store";
			categories[] = {"handguns", "launchers", "magazines", "mmgs", "optics", "pointers", "smgs", "underbarrel", "mrks", "ars", "ths"};
		};

		class pharmacy {
			displayName = "pharmacy Store";
			categories[] = {"pharmacyA"};
		};
	};	
};
