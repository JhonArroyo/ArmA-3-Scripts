...
- arguments for X and Y are optional. 
*/
/*
	File: infoText.sqf
	...
	* values may differ for different screen resolutions. I recommend using SafeZone.
	...
	examples:
        null = [["First line","Second line","Third line"], 0.01, 2] execVM "infoText.sqf";
        default settings from the original function.
...
(["BIS_fnc_infoText"] call bis_fnc_rscLayer) cuttext ["","plain"];